...
class discussionSetting(unittest.TestCase):
    ...
    def test_changeDiscussionName(self):
        ...
        time.sleep(2)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/personal_detail_edit').clear()
        time.sleep(2)
        number = random.randint(0, 1000)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/personal_detail_edit').send_keys("自动化修改讨论组名称%d" %number)
        time.sleep(2)

        #修改名称文本框字数统计比对
        lenth = len("自动化修改讨论组名称%d" %number)
        try:
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/personal_detail_edit_length_tip').text, (100-lenth))
        ...
        #获取新的讨论组名字，与设定的值进行比较
        new_name = self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/tv_group_name').text
        try:
        ...
        time.sleep(2)
        try:
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/title_bar_text').text, new_name)
        except AssertionError as e:
    ...
    def test_addMember(self):
        ...
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/action_setting').click()
        time.sleep(2)
        self.driver.find_element_by_xpath("//android.view.ViewGroup[@resource-id='com.yealink.uc.android.alpha:id/llyt_member_container']/android.widget.LinearLayout[3]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]").click()
        time.sleep(2)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/contact_search').clear()
        time.sleep(1)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/contact_search').send_keys("梁欣")
        time.sleep(1)
        self.driver.find_element_by_xpath("//android.widget.RelativeLayout[@resource-id='com.yealink.uc.android.alpha:id/contact_child_item']").click()
        time.sleep(1)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/right_tv').click()
        time.sleep(2)
        try:
            self.assertEqual(self.driver.find_element_by_xpath("//android.view.ViewGroup[@resource-id='com.yealink.uc.android.alpha:id/llyt_member_container']/android.widget.LinearLayout[3]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]").text,"梁欣")
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/tv_member_count').text,"查看5人")
            self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/left_btn').click()
            time.sleep(2)
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/title_member_count').text,"(5)")
    ...
    def test_delOneMember(self):
        ...
        time.sleep(2)
        #删除
        self.driver.find_element_by_xpath("//android.view.ViewGroup[@resource-id='com.yealink.uc.android.alpha:id/llyt_member_container']/android.widget.LinearLayout[5]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]").click()
        time.sleep(2)
        ...
        time.sleep(2)
        try:
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/right_tv').text,"删除(1)")
        except AssertionError as e:
            AssertionError("删除成员计数错误")
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/right_tv').click()
        time.sleep(1)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/button_ok').click()
        time.sleep(2)
        try:
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/tv_member_count').text, "查看2人")
    ...
    def test_delMoreMember(self):
        ...
        self.driver.find_element_by_xpath("//android.widget.RelativeLayout[@resource-id='com.yealink.uc.android.alpha:id/contact_child_item']").click()
        time.sleep(1)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/et_select_member_search').send_keys("刘博琛")
        time.sleep(1)
        self.driver.find_element_by_xpath("//android.widget.RelativeLayout[@resource-id='com.yealink.uc.android.alpha:id/contact_child_item']").click()
        time.sleep(1)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/right_tv').click()
        time.sleep(2)
        self.driver.find_element_by_xpath("//android.view.ViewGroup[@resource-id='com.yealink.uc.android.alpha:id/llyt_member_container']/android.widget.LinearLayout[6]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]").click()
        time.sleep(2)
        ...
        time.sleep(1)
        try:
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/right_tv').text,"删除(2)")
        except AssertionError as e:
            AssertionError("删除成员计数错误")
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/right_tv').click()
        time.sleep(1)
    ...
    def test_stick(self):
        ...
        time.sleep(1)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/edit').send_keys("林美霞")
        time.sleep(1)
        ...
        time.sleep(1)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/chat_bar_editor').send_keys("置顶用")
        time.sleep(2)
        ...
        group_name = self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/tv_group_name').text
        text = self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/switch_top').text
        ...
        if text == "开启":
            ...
            time.sleep(1)
            try:
                self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/switch_top').text, "开启")
                print("讨论组置顶成功")
            except AssertionError as e:
    ...
    def test_favorite(self):
        ...
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/action_setting').click()
        time.sleep(2)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/switch_frequent_contact').click()
        time.sleep(2)
        try:
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/switch_frequent_contact').text,"开启")
            print("设置特别关注成功")
        except AssertionError as e:
    ...
    def test_quitDiscussion(self):
        ...
        time.sleep(2)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/btn_quit_talk_group').click()
        time.sleep(2)
        self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/button_ok').click()
        time.sleep(2)
        #退出后回到主界面
        try:
            self.assertEqual(self.driver.find_element_by_id('com.yealink.uc.android.alpha:id/title').text,"消息")
            print("退出讨论组成功")
        except AssertionError as e:
